...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 1099,
    category: 'Mobile',
    imageUrl: 'https://raw.githubusercontent.com/danirando/auratablet/a4a8802da6fae6c04c8db441f8e08b7594cca043/tablet.png',
    gallery: [
            'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&q=80&w=1000',
            'https://images.unsplash.com/photo-1611532736597-b529231703ff?auto=format&fit=crop&q=80&w=1000'
             ],
  ...
  },
  {
    ...
    price: 599,
    category: 'Home',
    imageUrl: 'https://raw.githubusercontent.com/danirando/auraair/8560f195dca88de2514bffb3ae12880fd9ba1f11/Gemini_Generated_Image_e6nztje6nztje6nz.png',
    gallery: [
        'https://images.unsplash.com/photo-1597914787948-43d83b9e4a3c?auto=format&fit=crop&q=80&w=1000',
        'https://images.unsplash.com/photo-1612450622797-152e98822086?auto=format&fit=crop&q=80&w=1000'
    ],
...
export const JOURNAL_ARTICLES: JournalArticle[] = [
    ...
    },
    {
        ...
        content: React.createElement(React.Fragment, null,
            ...
            React.createElement("p", { className: "mb-6 text-[#5D5A53]" },
                "These textures find their way into our limited edition cases and the acoustic fabric of the Aura Harmony."
            )
        )
    }
];
